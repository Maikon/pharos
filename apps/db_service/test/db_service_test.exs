defmodule DbServiceTest do
  ...
  test "post is persisted" do
    ...
    post_persisted = DbService.persist("post", post_to_save)
  ...
  test "retrieves all posts" do
    DbService.persist("post", %{post_url: "post-url", description: "a-description"})
    DbService.persist("post", %{post_url: "another-post-url", description: "another-description"})
